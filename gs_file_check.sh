...
if [[ "$filecount" -ge 3 ]]; then
        subject="SUCCESS - ALL GS Sales files received for $filedate - File Count:$filecount"
        ...
        subject="P1: FAILED - NOT ALL 3 GS Sales files received for $filedate - File Count:$filecount"
